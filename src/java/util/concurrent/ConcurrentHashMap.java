...
public class ConcurrentHashMap<K,V> extends AbstractMap<K,V>
    ...
    public ConcurrentHashMap(int initialCapacity) {
        ...
        // MAXIMUM_CAPACITY >>> 1 = 00100...
        // initialCapacity = 100
        // initialCapacity >>> 1 = 10
        // initialCapacity + 1 = 101
        // initialCapacity >>> 1+1 = 11
        //
            ...
            // CAS 一下，将 sizeCtl 设置为 -1，代表抢到了锁
                ...
                try {
                    ...
                    if ((tab = table) == null || tab.length == 0) {
                        ...
                        table = tab = nt;
                        // 乘0.75
                        // sc一开始等于sizeClt,为初始化长度，之后*0.75,角色转换为扩容的阈值；
    ...
    private final void tryPresize(int size) {
        ...
        while ((sc = sizeCtl) >= 0) {
            ...
            if (tab == null || (n = tab.length) == 0) {
                ...
                // 这个方法的核心在于 sizeCtl 值的操作，
                // 首先将其设置为一个负数，然后执行 transfer(tab, null)，
                // 再下一个循环将 sizeCtl 加 1，并执行 transfer(tab, nt)，
